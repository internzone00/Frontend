    ...
    return (
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-6 py-12 md:py-20 items-center">
            <div className="space-y-6">
                ...
                <div className="pt-2">
                    <a href="#services">
                        <button className="px-8 py-3 text-lg font-semibold rounded-full bg-cyan-400 text-white hover:bg-cyan-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/30">
                            Explore Now →
                        </button>
                    </a>
                </div>
